...
triggers: ["/add-project", "/case-study"]
skills: ["markdown-scaffold"]
---

# Case Study Architect Command

This command guides the user through creating a professional project case study.
...
2. **File Creation**:
   - Use the `markdown-scaffold` skill to create a new file in `src/projects/[title-slug].md`.
