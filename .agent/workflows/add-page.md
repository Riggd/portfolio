...
# Add Primary Page Workflow

This workflow guides you through creating a new top-level page for your portfolio (e.g., a "Skills" or "Testimonials" page).
...
3. **File Creation**:
   - Create the new file in `src/[filename]`.
